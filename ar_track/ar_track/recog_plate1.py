...
class LicensePlateRecognition(Node):
    def __init__(self):
        super().__init__('license_plate_recognition')
        ...
        self.cv_img = cv2.imread('/home/ji/robot_ws/src/ar_track/ar_track/origin.png')
...
def main():
    ...
    try:   
        while rclpy.ok():
            ...
            webcam = node.cv_img
            if webcam is not None and not webcam.size == 0: 
                cv2.imshow('test', webcam)
